    ...
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> African</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> Fast Food</router-link>
