<template>
    ...
    <ul class="filter-option">
        <li>
            <input type="button" name="rPrice" id="r1500_5000" value="1500,5000" hidden
                @click="filterPriceBtn($event)" />
            <label for="r1500_5000" class="d-flex justify-content-between">1,500 Fcfa - 5,000 Fcfa
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
            </label>
        </li>

        <li>
            <input type="button" name="rPrice" id="r5000_10000" value="5000,10000" hidden
                @click="filterPriceBtn($event)" />
            <label for="r5000_10000" class="d-flex justify-content-between">5,000 Fcfa - 10,000 Fcfa
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
            </label>
        </li>

        <li>
            <input type="button" name="rPrice" id="r10000_15000" value="10000,15000" hidden
                @click="filterPriceBtn($event)" />
            <label for="r10000_15000" class="d-flex justify-content-between">10,000 Fcfa - 15,000 Fcfa
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
            </label>
        </li>

        <li>
            <input type="button" name="rPrice" id="rAbove15000" value="15000" hidden
                @click="filterPriceBtn($event)" />
            <label for="rAbove15000" class="d-flex justify-content-between">{{ ">" }} 15,000 Fcfa
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
            </label>
        </li>

        <li>
            <input type="button" name="rPrice" id="rBelow1500" value="1500" hidden
                @click="filterPriceBtn($event)" />
            <label for="rBelow1500" class="d-flex justify-content-between">{{ "<" }} 1,500 Fcfa
                <button class="unselect-btn" @click="unselectPriceBtn($event)">X</button>
            </label>
        </li>
    </ul>
    ...
    <input type="button" id="fastFoodFilterFoodBtn" name="fastFoodFilterFoodBtn" class="menu-tab-item" value="fast food" @click="filterFoodBtn($event)" />
    <input type="button" id="africanFilterFoodBtn" name="africanFilterFoodBtn" class="menu-tab-item"
    value="african" @click="filterFoodBtn($event)" />
                    ...
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="content">
                               ...
                               <div class="price">
    {{ (parseFloat(f.food_price) - parseFloat(f.food_discount)) + ' Fcfa' }}
    <span v-if="parseFloat(f.food_discount) != 0.00">
        {{ parseFloat(f.food_price) + ' Fcfa' }}
    </span>
</div>
...
export default {
    ...
    methods: {
        ...
        evaluatePrice: function (food, priceRange) {
            ...
            if (priceRange == "1500,5000") {
                if (1500 <= cal && cal <= 5000) {
                    return food;
                }
            }
            else if (priceRange == "5000,10000") {
                if (5000 <= cal && cal <= 10000) {
                    return food;
                }
            }
