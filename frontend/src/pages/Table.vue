    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>+225 01 01 90 50 20</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>Bingerville, Côte d'Ivoire</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7944.623987837179!2d-3.912381913929471!3d5.369297984892019!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1ed455bb35d31%3A0x66d98e0fe5af9b08!2sCit%C3%A9%20Bellevue%20Bingerville!5e0!3m2!1sen!2sci!4v1732954678126!5m2!1sen!2sci" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </div>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (this.orderObj.card) {
                if (!/^\d{10}$/.test(this.orderObj.card)) {
