        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                <div class="checkout-heading">
                    ...
                    <h3 v-if="user">{{ user.user_name }}'s Order<span>{{ calculateSummaryPrice()[3] }} Fcfa</span></h3>
                </div>
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="coAddress" id="coAddress" placeholder="Address in Côte d'Ivoire"
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.checkoutObj.phone) {
                ...
                if (!/^\d{10}$/.test(this.checkoutObj.phone)) {
