                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Summary</span>
                                <h3 class="font-bold total-first-price">{{ calculateSummaryPrice()[0] }} Fcfa</h3>

                                <span>Discount</span>
                                <h3 class="font-bold total-discount">{{ calculateSummaryPrice()[1] }} Fcfa</h3>

                                <span>Delivery fee</span>
                                <h3 class="font-bold total-delivery">{{ calculateSummaryPrice()[2] }} Fcfa</h3>

                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">{{ calculateSummaryPrice()[3] }} Fcfa</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +225 01 01 90 50 20</h3>
                                <span class="small">
